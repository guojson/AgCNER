...
data_arg.add_argument('--dataset_name', type=str, default='agcner')
data_arg.add_argument('--train_file', type=str, default='./data/dataset/agcner/train.char.bmes', help="train file")
data_arg.add_argument('--test_file', type=str,default='./data/dataset/agcner/test.char.bmes', help="test file")
data_arg.add_argument('--dev_file', type=str, default='./data/dataset/agcner/dev.char.bmes',help="dev file")
data_arg.add_argument('--gaz_file', type=str, default="E:/guo/NER/Flat-Lattice-Transformer-master/sgns.merge.word", help="lexical embeddings file")
data_arg.add_argument('--char_embedding_path', type=str, default=r"E:/guo/NER/Flat-Lattice-Transformer-master/gigaword_chn.all.a2b.uni.ite50.vec",help="characher embeddings file")
