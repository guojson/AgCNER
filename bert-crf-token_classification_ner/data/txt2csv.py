...
if __name__ == '__main__':
    json_dict = 'resume/label_2_id.json'
    get_dict('resume/train.char.bmes', json_dict)  # 生成label2id字典，存储到json_dict
    change('resume/train.char.bmes', 'resume/train.csv', json_dict)
    change('resume/test.char.bmes', 'resume/test.csv', json_dict)
    change('resume/dev.char.bmes', 'resume/dev.csv', json_dict)