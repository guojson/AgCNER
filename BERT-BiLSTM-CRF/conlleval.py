...
def report(counts, logger=None, out=None):
    ...
    logger.info('processed %d tokens with %d phrases; ' %
                (c.token_counter, c.found_correct))

    str='found: %d phrases; correct: %d.' % (c.found_guessed, c.correct_chunk)

    # logger.info('found: %d phrases; correct: %d.\n' %
    #             (c.found_guessed, c.correct_chunk))
    ...
    if c.token_counter > 0:
        ...
        # out.write('FB1: %6.2f\n' % (100. * overall.fscore))
        str+= ' accuracy: %6.2f%%; ' %(100. * c.correct_tags / c.token_counter)+'precision: %6.2f%%; ' % (100. * overall.prec)+'recall: %6.2f%%; ' % (100. * overall.rec)+'FB1: %6.2f' % (100. * overall.fscore)
    ...
    for i, m in sorted(by_type.items()):
        ...
        str2='%17s: ' % i+'precision: %6.2f%%; ' % (100. * m.prec)+'recall: %6.2f%%; ' % (100. * m.rec)+'FB1: %6.2f  %d' % (100. * m.fscore, c.t_found_guessed[i])
