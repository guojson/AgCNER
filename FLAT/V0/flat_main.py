...
from fastNLP.core.callback import WarmupCallback, GradientClipCallback, FitlogCallback
...
parser.add_argument('--dataset', default='resume', help='weibo|resume|ontonote|msra')
...
elif args.dataset == 'agcner':
    datasets, vocabs, embeddings = load_agcner_ner(agcner_ner_path, yangjie_rich_pretrain_unigram_path,
                                                   yangjie_rich_pretrain_bigram_path,
                                                   _refresh=refresh_data, index_token=False,
                                                   _cache_fp=raw_dataset_cache_name,
                                                   char_min_freq=args.char_min_freq,
...
loss = LossInForward()
encoding_type = 'bmeso'
if args.dataset == 'weibo' or args.dataset == 'agcner':
    encoding_type = 'bio'
