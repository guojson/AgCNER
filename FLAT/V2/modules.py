...
class Four_Pos_Fusion_Embedding(nn.Module):
    ...
    def forward(self,pos_s,pos_e):
        ...
        pe_ss = pos_ss.view(size=[batch, max_seq_len, max_seq_len, -1])
        pe_se = pos_se.view(size=[batch, max_seq_len, max_seq_len, -1])
        pe_es = pos_es.view(size=[batch, max_seq_len, max_seq_len, -1])
        pe_ee = pos_ee.view(size=[batch, max_seq_len, max_seq_len, -1])
        ...
        rel_pos_embedding = rel_pos_embedding.view(size=[batch, max_seq_len, max_seq_len, -1])
