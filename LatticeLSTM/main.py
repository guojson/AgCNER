...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default="data/model/saved_model_agcner.lstmcrf.")
    parser.add_argument('--savedset', help='Dir of saved data setting', default="data/save.dset")
    parser.add_argument('--train', default="data/agcner/train.char.bmes")
    parser.add_argument('--dev', default="data/agcner/dev.char.bmes" )
    parser.add_argument('--test', default="data/agcner/test.char.bmes")
    ...
    char_emb = r"E:\guo\NER\Flat-Lattice-Transformer-master\gigaword_chn.all.a2b.uni.ite50.vec"
    bichar_emb = None
    gaz_file = r"E:\guo\NER\Flat-Lattice-Transformer-master\ctb.50d.vec"
    # gaz_file = None
    # char_emb = None
    #bichar_emb = None
